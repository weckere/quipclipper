...
def test_build_args_video_embeds_sidecar_as_extra_input():
    args = build_mkvmerge_args(
        ...
        keep_subs=True, embed_subs=Path("subs.srt"),
    )
